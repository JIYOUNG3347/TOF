...
vector<int> arr(unsigned char* Data, int start_pixcel_1, int start_pixcel_2, float outlier);			// Split data to Distance data and Amplitude data function, outlier handling, Normalize
...
vector<int> arr(unsigned char* Data, int start_pixcel_1, int start_pixcel_2, float outlier) {
	vector<int> arr;
	int data;
